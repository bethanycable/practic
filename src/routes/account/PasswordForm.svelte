<script lang="ts">
	...
	import type { PasswordSchema, passwordSchema } from "$lib/schemas";
...
<section class="px-6 pt-16">
	...
	<form method="POST" action="?/updatePassword" use:enhance class="mt-8 flex flex-col space-y-4">
		...
		<label for="confirmPassword" class="space-y-2">
			<span>Confirm Password</span>
			<input type="password" name="passowrdConfirm" bind:value={$form.passwordConfirm} />
